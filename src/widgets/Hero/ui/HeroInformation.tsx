...
const HeroInformation: FC = () => {
   return (
      <article className='relative z-70 col-span-6 max-[64rem]:col-span-7'>
         {heroInformationItems.map((item) => (
            <div key={item.id} className=''>
               ...
               <p className='leading-large text-main-paragraph pt-10 text-justify text-white max-[87.8125rem]:text-[1rem]'>
                  {item.about}
               </p>
            </div>
         ))}
